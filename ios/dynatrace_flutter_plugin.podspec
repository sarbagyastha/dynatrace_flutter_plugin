Pod::Spec.new do |s|
	...
	s.name          = "dynatrace_flutter_plugin"
	s.version       = "2.237.0"
	s.summary       = "Monitor your Flutter application with Dynatrace."
	s.description   = "Dynatrace Plugin for Flutter"
	s.homepage      = "https://dynatrace.com"
	
	s.source           = { :path => '.' }
	s.source_files = 'Classes/**/*'
  
	s.dependency 'Flutter'
	s.dependency 'Dynatrace', '~> 8.235.1.1015'
	s.platform = :ios, '8.0'
